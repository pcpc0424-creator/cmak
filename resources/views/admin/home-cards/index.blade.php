        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase w-28">관리</th>
                </tr>
            </thead>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 text-right">
                            <div class="inline-flex items-center gap-2">
                                <a href="{{ url('/admin/home-cards/' . $card->id . '/edit') }}" class="text-sm text-blue-600 hover:text-blue-800">수정</a>
