        ...
        @php
            ...
            $menus = [
                ...
                ['title' => 'CM자료방', 'link' => "$bp/cmdata", 'sub' => [
                    ...
                    ['title' => '연구자료', 'link' => "$bp/cmdata/report"],
                    ['title' => 'CM관련법령', 'link' => "$bp/cmdata/law"],
                    ['title' => '교육세미나', 'link' => "$bp/cmdata/seminar"],
                    ['title' => 'VE자료', 'link' => "$bp/cmdata/ve"],
                    ['title' => '전문가칼럼', 'link' => "$bp/cmdata/expert"],
                    ['title' => '특집', 'link' => "$bp/cmdata/special"],
                    ['title' => '기타자료', 'link' => "$bp/cmdata/etc"],
                    ['title' => '언론보도', 'link' => "$bp/cmdata/press"],
                    ['title' => 'CM사례', 'link' => "$bp/cmdata/case"],
                    ['title' => '교육자료', 'link' => "$bp/cmdata/education"],
                ]],
                ['title' => '알림마당', 'link' => "$bp/notice", 'sub' => [
                    ...
                    ['title' => '온라인뉴스', 'link' => "$bp/notice/online"],
                    ['title' => '주요행사일정', 'link' => "$bp/notice/schedule"],
                ]],
                ['title' => '참여마당', 'link' => "$bp/community", 'sub' => [
                    ['title' => 'FAQ', 'link' => "$bp/community/faq"],
                    ['title' => '자유게시판', 'link' => "$bp/community/board"],
                    ['title' => '설문조사', 'link' => "$bp/community/survey"],
                    ['title' => 'BookReview', 'link' => "$bp/community/bookreview"],
                    ['title' => 'CM용어사전', 'link' => "$bp/community/wordbook"],
                    ['title' => '사진갤러리', 'link' => "$bp/community/gallery"],
