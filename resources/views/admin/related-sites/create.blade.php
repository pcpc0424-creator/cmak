        ...
        <div class="bg-white rounded-lg shadow p-6 space-y-6">
            ...
            <div>
                ...
                <select name="site_type" id="site_type"
                    ...
                    <option value="domestic" {{ old('site_type') === 'domestic' ? 'selected' : '' }}>국내관련기관</option>
                    <option value="international" {{ old('site_type') === 'international' ? 'selected' : '' }}>해외관련기관</option>
                    <option value="media" {{ old('site_type') === 'media' ? 'selected' : '' }}>언론관련기관</option>
                    <option value="government" {{ old('site_type') === 'government' ? 'selected' : '' }}>입찰관련기관</option>
                </select>
                @error('site_type')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
