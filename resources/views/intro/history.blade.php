...
@php
    $history = [
        ...
        // 구 영문홈 History(eng/html1/in_history.html)에만 있던 항목 복원.
        // 부처명은 구 홈페이지 표기 그대로 사용(2003년 당시 명칭은 교육인적자원부·행정자치부).
        ['year' => '2003', 'events' => [
            '03월 06일 : 교육과학기술부, 선택직무교육기관 지정',
            '01월 21일 : 행정안전부, 지방공무원 선택직무교육기관 지정',
        ]],
        ['year' => '2002', 'events' => [
